...
def check_components_linking(brep_inspector):
    ...
    print(
        "There are ", nb_unlinked_surfaces, " surfaces not linked to a unique vertex."
    )
...
def check_unique_vertices_linked_to_multiple_corners(brep_inspector):
    unique_vertices_linked_to_multiple_corners = (
        brep_inspector.unique_vertices_linked_to_multiple_corners()
    )
    print(
        "There are ",
        len(unique_vertices_linked_to_multiple_corners),
...
def check_unique_vertices_linked_to_multiple_internals_corner(brep_inspector):
    unique_vertices_linked_to_multiple_internals_corner = (
        brep_inspector.unique_vertices_linked_to_multiple_internals_corner()
    )
    print(
        "There are ",
        len(unique_vertices_linked_to_multiple_internals_corner),
...
def check_unique_vertices_linked_to_not_internal_nor_boundary_corner(brep_inspector):
    unique_vertices_linked_to_not_internal_nor_boundary_corner = (
        brep_inspector.unique_vertices_linked_to_not_internal_nor_boundary_corner()
    )
    print(
        "There are ",
        len(unique_vertices_linked_to_not_internal_nor_boundary_corner),
...
def check_unique_vertices_linked_to_line_with_wrong_relationship_to_surface(
    brep_inspector,
):
    unique_vertices_linked_to_line_with_wrong_relationship_to_surface = (
        brep_inspector.unique_vertices_linked_to_line_with_wrong_relationship_to_surface()
    )
    print(
        "There are ",
        len(unique_vertices_linked_to_line_with_wrong_relationship_to_surface),
...
def check_unique_vertices_linked_to_a_line_with_invalid_embeddings(brep_inspector):
    unique_vertices_linked_to_a_line_with_invalid_embeddings = (
        brep_inspector.unique_vertices_linked_to_a_line_with_invalid_embeddings()
    )
    print(
        "There are ",
        len(unique_vertices_linked_to_a_line_with_invalid_embeddings),
...
def check_unique_vertices_linked_to_a_single_and_invalid_line(brep_inspector):
    unique_vertices_linked_to_a_single_and_invalid_line = (
        brep_inspector.unique_vertices_linked_to_a_single_and_invalid_line()
    )
    print(
        "There are ",
        len(unique_vertices_linked_to_a_single_and_invalid_line),
...
def check_unique_vertices_linked_to_several_lines_but_not_linked_to_a_corner(
    brep_inspector,
):
    unique_vertices_linked_to_several_lines_but_not_linked_to_a_corner = (
        brep_inspector.unique_vertices_linked_to_several_lines_but_not_linked_to_a_corner()
    )
    print(
        "There are ",
        len(unique_vertices_linked_to_several_lines_but_not_linked_to_a_corner),
